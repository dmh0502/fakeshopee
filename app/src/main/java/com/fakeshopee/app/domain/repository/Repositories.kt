...
interface ProductRepository {
    ...
    fun getFilteredProductsStream(category: String, query: String, sortBy: String): Flow<List<Product>>
...
interface WalletRepository {
    ...
    suspend fun topUp(amount: Long, method: String): Result<Unit>
    suspend fun processPayment(amount: Long, orderTitle: String): Result<String>
}
