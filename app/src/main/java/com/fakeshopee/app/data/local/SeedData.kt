...
object SeedData {
    ...
    private val variantListAdapter = moshi.adapter<List<Map<String, Any>>>(
        Types.newParameterizedType(List::class.java, Types.newParameterizedType(Map::class.java, String::class.java, Any::class.java))
    )
    
    private val reviewListAdapter = moshi.adapter<List<Map<String, Any>>>(
        Types.newParameterizedType(List::class.java, Types.newParameterizedType(Map::class.java, String::class.java, Any::class.java))
    )
    ...
    val INITIAL_PRODUCTS = listOf(
        ProductEntity(
            ...
            specsJson = mapAdapter.toJson(mapOf(
            ...
            highlightsJson = stringListAdapter.toJson(listOf("200MP Computational Sensor", "120W HyperCharge", "Quantum Core G9")),
            variantsJson = variantListAdapter.toJson(listOf(
            ...
            stockQuantity = 42,
            isFavorite = true,
            reviewsJson = reviewListAdapter.toJson(listOf(
                mapOf(
                    "id" to "rev-1",
                    "author" to "Jason D.",
                    "rating" to 5.0,
        ...
        ProductEntity(
            ...
            highlightsJson = stringListAdapter.toJson(listOf("Neural M4 Max Silicon", "64GB Unified Memory", "120Hz Liquid Retina")),
            variantsJson = variantListAdapter.toJson(listOf(
        ...
        ProductEntity(
            ...
            highlightsJson = stringListAdapter.toJson(listOf("Dual 4K Micro-OLED", "78g Ultra-lightweight", "6DoF Spatial Tracking")),
            variantsJson = variantListAdapter.toJson(listOf(
        ...
        ProductEntity(
            ...
            highlightsJson = stringListAdapter.toJson(listOf("48dB Active Noise Cancellation", "Lossless 24-bit 192kHz", "38 Hours Total Battery")),
            variantsJson = variantListAdapter.toJson(listOf(
        ...
        ProductEntity(
            ...
            highlightsJson = stringListAdapter.toJson(listOf("Hall Effect Zero-Drift", "1000Hz Polling Rate", "Adaptive Micro-Triggers")),
            variantsJson = variantListAdapter.toJson(listOf(
    ...
    suspend fun seedDatabaseIfEmpty(context: Context, database: AppDatabase) = withContext(Dispatchers.IO) {
        val prefs = context.getSharedPreferences("fakeshopee_prefs", Context.MODE_PRIVATE)
        if (prefs.getBoolean("is_database_seeded", false)) {
            return@withContext
        }
        ...
        if (walletDao.getWalletOnce() == null) {
            walletDao.setWallet(
                WalletEntity(
                    id = 1,
                    availableBalance = 425000L,
                    monthlySpend = 277800L
                )
            )
        }
        ...
        prefs.edit().putBoolean("is_database_seeded", true).apply()
    }
}
